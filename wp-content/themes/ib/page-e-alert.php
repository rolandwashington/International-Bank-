                        ...
                        <form action="<?php echo site_url() ?>/e-alert" method="POST" enctype="multipart/form-data">
                            <div class="application-form">                            
                                ...
                                <div class="is-account">
                                    ...
                                    <button id="submit-e-alert-application-form" type="submit" name="submit-e-alert" class="wpcf7-form-control wpcf7-submit btn form-half-width service-button">Submit Application</button>                               
                                </div>
                            </div>
                        </form>
...
<script>
    $(document).on('click', '#submit-e-alert-application-form', function () {
