(function ($) {
    ...
    Royal_Preloader.config({
        mode: 'logo',
        logo: '/wp-content/themes/ib/images/ib-brand-logo-with-name.png',
        logo_size: [170, 60],
        showProgress: true,
        showPercentage: true,
        text_colour: '#0a0f2b',
    ...
    $('.image-carousel').each(function () {
        ...
        $(this).slick({
            ...
            slidesToScroll: 1,
            arrows: $arr,
            prevArrow: '<button type="button" class="prev-nav"><i class="fab fa-angle-left"></i></button>',
            nextArrow: '<button type="button" class="next-nav"><i class="fab fa-angle-right"></i></button>',
            autoplay: true,
            autoplaySpeed: 7000,
            responsive: [
                {
