	...
	<div class="page-header" style="background-image: url(<?php echo get_template_directory_uri(); ?>/images/ib-background.jpg);">
		<div class="container">
			<div class="breadc-box no-line">
				<div class="row">
					<div class="col-md-6">
						<h1 class="page-title">E-Statement <?php if (!empty($ThankYou)) { echo $ThankYou; } ?></h1>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="boxed-content">
				...
				<div class="career-box" id="ib-application-form">
					...
					<div class="content-box">
                        <form action="<?php echo site_url() . "/e-statement" ?>" method="POST" enctype="multipart/form-data">
