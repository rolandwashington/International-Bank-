													...
													<div class="wpb_wrapper target-ib-links-inservices">
														...
														<div class="wpb_text_column wpb_content_element">
															<div class="wpb_wrapper">
																<p><span>Online banking</span> - Run your business more efficiently with our Online banking solutions. You can manage your account, review and approve transactions and access your account information anytime, anywhere. <a class="link-box pagelink" href="<?php echo site_url() ?>/apply-for-internet-banking">Sign up for Online Banking</a></p>
																<p><span>e-Statement</span> -  Need your account statement? There's no need to make the trip to the bank. We can digitally send your account statement whenever you need it, or have them sent to you periodically. <a class="link-box pagelink" href="<?php echo site_url() ?>/e-statement">Sign up for e-Statements</a></p>
																<p><span>e-Alerts</span> - Get notified of every transaction via your account. Notifications about withdrawals, deposits and check encashment will be sent to you via email or sms. All alerts will include your updated account balance. <a class="link-box pagelink" href="<?php echo site_url() ?>/e-alert">Sign up for e-Alert</a></p>
