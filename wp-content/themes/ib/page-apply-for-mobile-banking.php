	...
	<div class="page-header" style="background-image: url(<?php echo get_template_directory_uri(); ?>/images/ib-background.jpg);">
		<div class="container">
			<div class="breadc-box no-line">
				<div class="row">
					<div class="col-md-6">
						<h1 class="page-title">Mobile Banking <?php if (!empty($ThankYou)) { echo $ThankYou; } ?></h1>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="boxed-content">
				...
				<div class="career-box" id="ib-application-form">
					...
					<div class="content-box">
                        <form action="<?php echo site_url() ?>/apply-for-mobile-banking" method="POST" enctype="multipart/form-data">
                            <div class="application-form">                            
                                ...
                                <div class="is-account">
                                    ...
                                    <button type="submit" id="submit-mobile-banking" name="internet-banking" class="wpcf7-form-control wpcf7-submit btn form-half-width service-button">Submit Application</button>                               
                                </div>
                            </div>
                        </form>
...
<script>
    $(document).on('click', '#submit-mobile-banking', function () {
